...
import 'package:spend_spent_spent/home/state/menu_state.dart';
...
class MainMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => MenuCubit(tabsRouter.activeIndex, tabsRouter),
      child: BlocBuilder<AppSettingsCubit, AppSettingsState>(
        builder: (context, state) {
          int selectedIndex = context.select((MenuCubit c) => c.state);
