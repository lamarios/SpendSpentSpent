...
extension SearchParametersPatterns on SearchParameters {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SearchParameters value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<Category> categories, int minAmount, int maxAmount,
            String note)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _SearchParameters() when $default != null:
        return $default(
            _that.categories, _that.minAmount, _that.maxAmount, _that.note);
      case _:
        return orElse();
    }
  }
