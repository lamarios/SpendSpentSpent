...
extension DiffWithPreviousMonthGraphStatePatterns
    on DiffWithPreviousMonthGraphState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_DiffWithPreviousMonthGraphState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _DiffWithPreviousMonthGraphState() when $default != null:
        return $default(_that.loading, _that.includeRecurring,
            _that.currentPeriod, _that.spots, _that.previousPeriod);
      case _:
        return orElse();
    }
  }
