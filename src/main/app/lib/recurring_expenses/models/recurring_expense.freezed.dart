...
mixin _$RecurringExpense {
 ...
 String? get nextOccurrence; String? get lastOccurrence; double get amount; int get type; bool get income; Category get category; int get typeParam; int? get id; String get name;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,nextOccurrence,lastOccurrence,amount,type,income,category,typeParam,id,name);
...
@useResult
$Res call({
 String? nextOccurrence, String? lastOccurrence, double amount, int type, bool income, Category category, int typeParam, int? id, String name
});
...
/// Create a copy of RecurringExpense
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? nextOccurrence = freezed,Object? lastOccurrence = freezed,Object? amount = null,Object? type = null,Object? income = null,Object? category = null,Object? typeParam = null,Object? id = freezed,Object? name = null,}) {
  return _then(_self.copyWith(
nextOccurrence: freezed == nextOccurrence ? _self.nextOccurrence : nextOccurrence // ignore: cast_nullable_to_non_nullable
as String?,lastOccurrence: freezed == lastOccurrence ? _self.lastOccurrence : lastOccurrence // ignore: cast_nullable_to_non_nullable
...
as Category,typeParam: null == typeParam ? _self.typeParam : typeParam // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? nextOccurrence,  String? lastOccurrence,  double amount,  int type,  bool income,  Category category,  int typeParam,  int? id,  String name)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecurringExpense() when $default != null:
return $default(_that.nextOccurrence,_that.lastOccurrence,_that.amount,_that.type,_that.income,_that.category,_that.typeParam,_that.id,_that.name);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? nextOccurrence,  String? lastOccurrence,  double amount,  int type,  bool income,  Category category,  int typeParam,  int? id,  String name)  $default,) {final _that = this;
switch (_that) {
case _RecurringExpense():
return $default(_that.nextOccurrence,_that.lastOccurrence,_that.amount,_that.type,_that.income,_that.category,_that.typeParam,_that.id,_that.name);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? nextOccurrence,  String? lastOccurrence,  double amount,  int type,  bool income,  Category category,  int typeParam,  int? id,  String name)?  $default,) {final _that = this;
switch (_that) {
case _RecurringExpense() when $default != null:
return $default(_that.nextOccurrence,_that.lastOccurrence,_that.amount,_that.type,_that.income,_that.category,_that.typeParam,_that.id,_that.name);case _:
  return null;
...
class _RecurringExpense implements RecurringExpense {
  const _RecurringExpense({this.nextOccurrence, this.lastOccurrence, required this.amount, this.type = 1, this.income = false, required this.category, required this.typeParam, this.id, required this.name});
  factory _RecurringExpense.fromJson(Map<String, dynamic> json) => _$RecurringExpenseFromJson(json);

@override final  String? nextOccurrence;
@override final  String? lastOccurrence;
...
/// Create a copy of RecurringExpense
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? nextOccurrence = freezed,Object? lastOccurrence = freezed,Object? amount = null,Object? type = null,Object? income = null,Object? category = null,Object? typeParam = null,Object? id = freezed,Object? name = null,}) {
