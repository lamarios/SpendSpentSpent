...
mixin _$AddCategoryState {
 ...
 String get selected; AvailableCategories get categories;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddCategoryState&&(identical(other.selected, selected) || other.selected == selected)&&(identical(other.categories, categories) || other.categories == categories));
}
...
@useResult
$Res call({
 String selected, AvailableCategories categories
});
...
/// Create a copy of AddCategoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selected = null,Object? categories = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String selected,  AvailableCategories categories)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddCategoryState() when $default != null:
return $default(_that.selected,_that.categories);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String selected,  AvailableCategories categories)  $default,) {final _that = this;
switch (_that) {
case _AddCategoryState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String selected,  AvailableCategories categories)?  $default,) {final _that = this;
switch (_that) {
case _AddCategoryState() when $default != null:
return $default(_that.selected,_that.categories);case _:
  return null;
...
class _AddCategoryState implements AddCategoryState {
  const _AddCategoryState({this.selected = '', this.categories = const AvailableCategories()});
  

@override@JsonKey() final  String selected;
@override@JsonKey() final  AvailableCategories categories;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AddCategoryState&&(identical(other.selected, selected) || other.selected == selected)&&(identical(other.categories, categories) || other.categories == categories));
}
...
@override $AvailableCategoriesCopyWith<$Res> get categories;
...
/// Create a copy of AddCategoryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selected = null,Object? categories = null,}) {
