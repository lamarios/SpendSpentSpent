...
extension CategorySettingsStatePatterns on CategorySettingsState {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CategorySettingsState value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<Category> categories, List<Category> toDelete,
            int expensesToDelete, dynamic error, StackTrace? stackTrace)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _CategorySettingsState() when $default != null:
        return $default(_that.categories, _that.toDelete,
            _that.expensesToDelete, _that.error, _that.stackTrace);
      case _:
        return orElse();
    }
  }
