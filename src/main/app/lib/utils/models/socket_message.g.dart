...
_SssSocketMessage _$SssSocketMessageFromJson(Map<String, dynamic> json) => _SssSocketMessage(
  message: json['message'] as Map<String, dynamic>,
  type: $enumDecode(_$SssSocketMessageTypeEnumMap, json['type']),
);

Map<String, dynamic> _$SssSocketMessageToJson(_SssSocketMessage instance) => <String, dynamic>{
