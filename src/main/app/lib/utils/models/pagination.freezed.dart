...
extension PaginationPatterns on Pagination {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int page, int total, int currentPageCount, int pageSize,
            int totalPages)?
        $default, {
    required TResult orElse(),
  }) {
    ...
    switch (_that) {
      case _Pagination() when $default != null:
        return $default(_that.page, _that.total, _that.currentPageCount,
            _that.pageSize, _that.totalPages);
      case _:
        return orElse();
    }
  }
