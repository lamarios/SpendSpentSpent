...
extension UserPatterns on User {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _User() when $default != null:
        return $default(_that.email, _that.firstName, _that.lastName, _that.id,
            _that.password, _that.isAdmin, _that.subscriptionExpiry);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(String email, String firstName, String lastName,
            String? id, String? password, bool isAdmin, int? subscriptionExpiry)
        $default,
  ) {
    final _that = this;
    switch (_that) {
