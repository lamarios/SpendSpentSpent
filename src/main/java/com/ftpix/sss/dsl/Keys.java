...
public class Keys {
    ...
    public static final ForeignKey<CategoryRecord, UserRecord> CATEGORY__FK_CATEGORY_USER = Internal.createForeignKey(Category.CATEGORY, DSL.name("fk_category_user"), new TableField[] { Category.CATEGORY.USER_ID }, Keys.USER_PKEY, new TableField[] { User.USER.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<ExpenseRecord, CategoryRecord> EXPENSE__FK_EXPENSE_CATEGORY = Internal.createForeignKey(Expense.EXPENSE, DSL.name("fk_expense_category"), new TableField[] { Expense.EXPENSE.CATEGORY_ID }, Keys.CATEGORY_PKEY, new TableField[] { Category.CATEGORY.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    ...
    public static final ForeignKey<HouseholdMembersRecord, HouseholdRecord> HOUSEHOLD_MEMBERS__FK_HOUSEHOLD = Internal.createForeignKey(HouseholdMembers.HOUSEHOLD_MEMBERS, DSL.name("fk_household"), new TableField[] { HouseholdMembers.HOUSEHOLD_MEMBERS.HOUSEHOLD_ID }, Keys.HOUSEHOLD_PKEY, new TableField[] { Household.HOUSEHOLD.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<HouseholdMembersRecord, UserRecord> HOUSEHOLD_MEMBERS__FK_HOUSEHOLD_INVITED_BY = Internal.createForeignKey(HouseholdMembers.HOUSEHOLD_MEMBERS, DSL.name("fk_household_invited_by"), new TableField[] { HouseholdMembers.HOUSEHOLD_MEMBERS.INVITED_BY_ID }, Keys.USER_PKEY, new TableField[] { User.USER.ID }, true, ForeignKeyRule.NO_ACTION, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<HouseholdMembersRecord, UserRecord> HOUSEHOLD_MEMBERS__FK_HOUSEHOLD_USER = Internal.createForeignKey(HouseholdMembers.HOUSEHOLD_MEMBERS, DSL.name("fk_household_user"), new TableField[] { HouseholdMembers.HOUSEHOLD_MEMBERS.USER_ID }, Keys.USER_PKEY, new TableField[] { User.USER.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<MonthlyHistoryRecord, CategoryRecord> MONTHLY_HISTORY__FK_MONTHLY_HISTORY_CATEGORY = Internal.createForeignKey(MonthlyHistory.MONTHLY_HISTORY, DSL.name("fk_monthly_history_category"), new TableField[] { MonthlyHistory.MONTHLY_HISTORY.CATEGORY_ID }, Keys.CATEGORY_PKEY, new TableField[] { Category.CATEGORY.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<RecurringExpenseRecord, CategoryRecord> RECURRING_EXPENSE__FK_RECURRING_EXPENSE_CATEGORY = Internal.createForeignKey(RecurringExpense.RECURRING_EXPENSE, DSL.name("fk_recurring_expense_category"), new TableField[] { RecurringExpense.RECURRING_EXPENSE.CATEGORY_ID }, Keys.CATEGORY_PKEY, new TableField[] { Category.CATEGORY.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
    public static final ForeignKey<YearlyHistoryRecord, CategoryRecord> YEARLY_HISTORY__FK_YEARLY_HISTORY_CATEGORY = Internal.createForeignKey(YearlyHistory.YEARLY_HISTORY, DSL.name("fk_yearly_history_category"), new TableField[] { YearlyHistory.YEARLY_HISTORY.CATEGORY_ID }, Keys.CATEGORY_PKEY, new TableField[] { Category.CATEGORY.ID }, true, ForeignKeyRule.CASCADE, ForeignKeyRule.NO_ACTION);
}
