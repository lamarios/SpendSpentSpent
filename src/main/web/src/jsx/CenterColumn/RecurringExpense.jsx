        ...
        return <div className={'RecurringExpense'} onClick={this.flip}>
            <div className={'bar ' + (this.state.flip === true ? 'flip' : '')} style={this.props.style}>
                ...
                <div className={"back fade-in"}>
                    ...
                    {this.props.expense.lastOccurrence &&
            ...
            {this.state.confirm &&
            <OkCancelDialog onOk={() => this.props.delete(this.props.expense.id)}
                            dismiss={() => this.setState({confirm: false})}>
                <div>
                    <p>
                        Are you sure ? <small>This won't delete the previous expenses generated by this recurring
                        expense.
                    </small>
                    </p>
                    {/*<p className={'options'}>*/}
